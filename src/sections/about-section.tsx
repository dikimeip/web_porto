    ...
    return (
        <Section title="About">
            <div className="text-sm/6.5">
                <p>
                    Saya adalah seorang programmer yang aktif sejak tahun 2020 dan telah mengerjakan berbagai proyek pengembangan aplikasi web dan mobile. Dalam pengembangan web, saya berpengalaman menggunakan Laravel, PHP, Bootstrap, Vue.js, dan React untuk membangun sistem yang responsif, efisien, dan mudah digunakan.
                </p>
                <p className="mt-5">
